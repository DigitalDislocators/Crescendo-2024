...
public class TestFivePiece extends SequentialCommandGroup {
  public TestFivePiece(SwerveSys swerveSys, FeederSys feederSys, RollersSys rollersSys, PivotSys pivotSys) {
    addCommands(
      ...
      new AutoGroundIntakeCmd(pivotSys, feederSys, rollersSys),
