...
public class AmpMidlineThree extends SequentialCommandGroup {
  public AmpMidlineThree(SwerveSys swerveSys, FeederSys FeederSys, RollersSys RollersSys, PivotSys PivotSys, SpacebarSys SpacebarSys) {
    addCommands(
